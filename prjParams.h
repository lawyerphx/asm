...
/*
GENERATED: Thu May 03 20:46:27 China Standard Time 2018
...
#define DEFAULT_BOOT_LINE "cpm(0,0)host:vxWorks55.cs850 h=10.105.243.42 e=10.105.243.73 u=target pw=9"
#undef  RESERVED
...
#undef  RAM_HIGH_ADRS
#define RAM_HIGH_ADRS (LOCAL_MEM_LOCAL_ADRS + 0x00200000)
#undef  RAM_LOW_ADRS
#define RAM_LOW_ADRS (LOCAL_MEM_LOCAL_ADRS + 0x00010000)
#undef  ROM_BASE_ADRS
#define ROM_BASE_ADRS 0x02800000
#undef  ROM_TEXT_ADRS
#define ROM_TEXT_ADRS ROM_BASE_ADRS + 0x10100
#undef  ROM_SIZE
